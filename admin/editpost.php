            ...
            <div class="box round first grid">
             ...
             if (empty($title) || empty($catid) || empty($body) || empty($author) || empty($tags) || empty($uid) ) {
              ...
              if (!empty($file_name)) {
                    ...
                    $result = $db-> updatePostWNewImage($catid,$title,$body,$uploaded_image,$author,$tags,$uid,$editId);
                            if ($result) {
                    ...
                    $result = $db-> updatePostWOldImage($catid,$title,$body,$author,$tags,$uid,$editId);
                            if ($result) {
                             echo "<span class='success'>Data Updated Successfully.
                             </span>";
                            }else {
                ...
                <div class="block">  
                <?php
                       $postresult = $db-> getPostById($editId);
                       if ($postresult) {
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    ...
                    value="<?php  echo $item['id']; ?>"><?php   echo $item['name']; ?>
                        ...
                        <tr>
                            ...
                            <td >
                            <img src="<?php  echo $singlepost['image'];?>" height="50px" width="70px"><br>
